...
<div>
   <h2>Level Matrix Document Volume: gt_structure_3_1</h2>
...
<div>
   ...
   <table class="volumelevel">
      <tr>
         <td class="vname" colspan="2">gt_structure_3_1</td>
      </tr>
      <tr>
         <td class="url" colspan="2">
            <a href="https://github.com/OCR-D/gt_structure_3_1">https://github.com/OCR-D/gt_structure_3_1</a>
         </td>
      </tr>
      <tr>
         <td class="description" colspan="2">The repo gt_structure_3_1 is part of the OCR-D Ground Truth Structure corpus. Only the structure of the printed page is annotated. The corpus was created as a result of the DFG project OCR-D. Corrections and extensions can be reported, please use the Issues.</td>
      </tr>
      <tr>
...
https://ocr-d.de/en/gt-guidelines/trans/structur_gt.html</td>
      ...
      <tr>
         <td>
            <ul class="grid-l">
               <li class="key16">1649</li>
               <li class="key1">6123</li>
               <li class="key4">113</li>
               <li class="key5">31</li>
               <li class="key7">258</li>
               <li class="key8">2</li>
            </ul>
            <details>
